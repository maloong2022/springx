 ...
 *
 * <p><i>Requires CGLIB 2.1+ on the classpath.</i>. As of Spring 2.0, earlier CGLIB versions are not
 * supported anymore.
 *
 * <p>Objects of this type should be obtained through proxy factories, configured by an
