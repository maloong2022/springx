 ...
 * capabilities specified by the class. Implements the {@link
 * com.updownx.springx.beans.factory.config.AutowireCapableBeanFactory} interface in addition to
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
  ...
  protected Object createBean(String beanName, BeanDefinition beanDefinition, Object[] args)
    ...
    try {
      ...
      throw new BeansException("Cannot instantiate bean " + beanDefinition.getBeanClass(), e);
    }
