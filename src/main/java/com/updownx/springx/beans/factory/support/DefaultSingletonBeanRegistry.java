...
import com.updownx.springx.beans.factory.ObjectFactory;
...
public class DefaultSingletonBeanRegistry implements SingletonBeanRegistry {
  ...
  /** 二级缓存，提前暴漏对象，没有完全实例化的对象 Cache of early singleton objects: bean name --> bean instance */
  protected final Map<String, Object> earlySingletonObjects = new HashMap<String, Object>();

  /** 三级缓存，存放代理对象 Cache of singleton factories: bean name --> ObjectFactory */
  private final Map<String, ObjectFactory<?>> singletonFactories =
      new HashMap<String, ObjectFactory<?>>();

  private final Map<String, DisposableBean> disposableBeans = new LinkedHashMap<>();

  /** 一级缓存，普通对象 Cache of singleton objects: bean name --> bean instance */
